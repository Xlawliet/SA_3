 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://example/", wsdlLocation = "http://127.0.0.1:9091/Service/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:9091/Service/HelloWorld?wsdl");
